...
void setup() {
  ...
  okuriSound = new SoundFile(this, "/Users/makoto/Documents/Processing/cloth_wireless/okuri.wav");
  modoriSound = new SoundFile(this, "/Users/makoto/Documents/Processing/cloth_wireless/modori.wav");
  ...
  wsc = new WebsocketClient(this, "ws://192.168.43.147:8081");
}
